...
<button style="background-color:red;top:-300px;position:RELATIVE;left:1500px;height:30px;width:120px;border-radius:0px;color:white;"><a href="logout.php" ><h4 style="color:white;">LOGOUT</h4><br></a></button>
<div class="scroll">
